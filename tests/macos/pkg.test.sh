...
assert_success "rig-pkg-add has summary" grep -q 'rig:summary=' "$RIG_REPO/unix/macos/bin/rig-pkg-add"
assert_success "rig-pkg-remove has summary" grep -q 'rig:summary=' "$RIG_REPO/unix/macos/bin/rig-pkg-remove"
assert_success "rig-pkg-search has summary" grep -q 'rig:summary=' "$RIG_REPO/unix/macos/bin/rig-pkg-search"
assert_success "rig-pkg-list has summary" grep -q 'rig:summary=' "$RIG_REPO/unix/macos/bin/rig-pkg-list"
assert_success "rig-stow has summary" grep -q 'rig:summary=' "$RIG_REPO/unix/macos/bin/rig-stow"
assert_success "rig-add has summary" grep -q 'rig:summary=' "$RIG_REPO/unix/macos/bin/rig-add"
